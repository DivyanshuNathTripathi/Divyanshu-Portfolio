          ...
          <div className="flex-1 flex flex-col justify-between">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-6">
              ...
              <div className="bg-black/15 border border-white/10 rounded-2xl p-4">
                ...
                <a href="https://linkedin.com/in/divyanshu-nath-tripathi" target="_blank" rel="noopener noreferrer" className="text-sm font-bold hover:underline">divyanshu-nath-tripathi</a>
              </div>
            </div>
          </div>
